...
@Component({
  selector: 'app-admin-products-subcategories',
  templateUrl: './admin-products-subcategories.component.html',
  styleUrls: ['./admin-products-subcategories.component.scss']
})
export class AdminProductSubCategoriesComponent {

  displayedColumns: string[] = ['id', 'categoryName', 'categoryId'];
